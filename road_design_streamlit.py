...
def load_data():
    ...
    gdf_baguio = gpd.read_file("C:/Users/franj/notebooks/road design/gpkg_exports/baguio_roads.gpkg")
    gdf_zurich = gpd.read_file("C:/Users/franj/notebooks/road design/gpkg_exports/zurich_roads.gpkg")
